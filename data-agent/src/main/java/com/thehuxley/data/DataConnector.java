...
public class DataConnector {
	...
	static Logger logger = LoggerFactory.getLogger(DataConnector.class);
	private static DataConnector singleton = null;
	...
	private DataConnector() {
		...
		try {
			...
			properties = Configurator.getProperties(DataConstants.CONF_FILENAME);
