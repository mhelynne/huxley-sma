...
public class HuxleyConnector {

	static Logger logger = LoggerFactory.getLogger(HuxleyConnector.class);
	private static HuxleyConnector singleton = null;

	private ComboPooledDataSource pool;

	private HuxleyConnector() {
